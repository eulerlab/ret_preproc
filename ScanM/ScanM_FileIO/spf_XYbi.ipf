...
// ---------------------------------------------------------------------------------- 
function xyBi (wScanPathFuncParams)
...
//
// ---------------------------------------------------------------------------------- 
function xyBi_prepareDecode(wStimBufData, wScanPathFuncParams)
...
//		wImgFrame[][]
// ---------------------------------------------------------------------------------- 
function xyBi_decode(wImgFrame, wImgFrameAv, wPixelDataBlock, sCurrConfPath, wParams)
